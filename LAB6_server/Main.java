...
public class Main {
	...
	public static void main(String[] args) {
		...
		var commandManager = new CommandManager() {{
			...
			register("print_field_descending_price", new PrintFieldDescendingPrice(collectionManager));
			register("remove_any_by_venue", new RemoveAnyByVenue(collectionManager));
